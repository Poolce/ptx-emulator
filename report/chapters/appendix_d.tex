...
\begin{itemize}
  \item \texttt{[HH:MM:SS.mmm]}~--- монотонная временная метка
        (метод \texttt{FormatTimestamp} класса \texttt{Profiler}).
  \item \texttt{[PC: 0xHHHH...]}~--- монотонный PC инструкции
        в шестнадцатеричном виде (16 символов, дополненных нулями).
