...
вторая~--- голую мнемонику (например, \texttt{fma}).
...
Статический метод \texttt{Make(line)} применяет единственный
скомпилированное выражение, охватывающее всю строку,
...
инструкции счётчик инкрементируется; значение используется как индекс
