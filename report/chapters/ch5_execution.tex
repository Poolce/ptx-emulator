...
\begin{lstlisting}[language=C++, caption={Базовый класс инструкции}]
class Instruction {
public:
...
Накладные расходы~--- одна косвенная адресация через vtable.

\subsubsection{Кодогенерация классов инструкций}
...
Принцип открытости/закрытости (OCP)~\cite{GoF1994}: добавление
поддержки новой инструкции сводится к добавлению записи
...
\texttt{memcpy}~--- это единственный способ избежать UB по правилу
strict aliasing в C++.
