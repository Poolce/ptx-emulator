...
диспетчера) обеспечивает строгое разделение ответственности: синтаксическийй анализатор отвечает
...
в JSON предотвращает рассинхронизацию между синтаксическим анализатором, фабрикой
и тестами.
