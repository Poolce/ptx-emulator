...
Реальный GPU следует семантике PTX-спецификации аппаратно, поэтому
эти граничные случаи обрабатываются явно~--- иначе верифицируемые
значения расходились бы при корректном поведении на типичных путях.
